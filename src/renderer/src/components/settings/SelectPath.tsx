...
const SelectPath = () => {
  ...
  return (
    <div className='flex flex-row gap-10 items-center'>
      <h3 className='text-white text-xl'>Download Path</h3>
      <div className='flex flex-row gap-10 items-center'>
        <div className="border border-white rounded-md px-4 py-2 text-gray-400 text-lg overflow-hidden text-ellipsis whitespace-nowrap w-96">
